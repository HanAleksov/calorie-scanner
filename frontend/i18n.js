const TRANSLATIONS = {
  en: {
    ...
    analyst_feed_title: "Analyst Feed",
    analyst_feed_history_label: "+ Show recent history",
    analyst_feed_no_history: "No earlier entries yet.",
    auto_apply_toggle_label: "Auto-Apply Targets Automatically",
    auto_apply_toggle_desc: "When on, the Analyst engine can change your calorie/macro targets by itself after a new weigh-in. When off, it still evaluates and logs to the Analyst Feed, but never changes your targets without you applying it manually.",
    auto_apply_enabled_toast: "Auto-apply turned on",
    auto_apply_disabled_toast: "Auto-apply turned off",

    gap_recommender_title: "Target Gap Recommender",
    gap_recommender_explain: "You still have {remaining} kcal left today — here are some dense, low-volume options to help close the gap.",
    gap_meal_liquid_bulk: "Liquid Bulk: 400ml whole milk + 1 scoop whey + 40g peanut butter",
    gap_meal_yogurt_bowl: "Yogurt Bowl: 300g full-fat Greek yogurt + 60g granola + 20g honey",
    gap_meal_pb_toast: "PB Toast Stack: 2 slices bread + 40g peanut butter + 1 banana",
    ...
    scan_scale_btn: "Scan scale screenshot",
    scale_scanning: "Reading…",
    scale_scan_success: "Scale reading captured — review and hit Log",
    scale_body_fat_pct_label: "Body fat",
    scale_bmr_kcal_label: "BMR",
    scale_protein_pct_label: "Protein",
  ...
  bg: {
    ...
    analyst_feed_title: "Анализи",
    analyst_feed_history_label: "+ Покажи скорошна история",
    analyst_feed_no_history: "Все още няма по-стари записи.",
    auto_apply_toggle_label: "Автоматично прилагане на целите",
    auto_apply_toggle_desc: "Когато е включено, анализиращият механизъм може сам да променя калорийните/макро цели след ново измерване на тегло. Когато е изключено, той пак анализира и записва в дневника, но никога не променя целите без ти да ги приложиш ръчно.",
    auto_apply_enabled_toast: "Автоматичното прилагане е включено",
    auto_apply_disabled_toast: "Автоматичното прилагане е изключено",

    gap_recommender_title: "Запълване на дневната цел",
    gap_recommender_explain: "Остават ти {remaining} кал. за деня — ето няколко калорийно плътни, но с малък обем опции.",
    gap_meal_liquid_bulk: "Течен обем: 400мл пълномаслено мляко + 1 мерителна лъжица суроватъчен протеин + 40г фъстъчено масло",
    gap_meal_yogurt_bowl: "Купа кисело мляко: 300г пълномаслено гръцко кисело мляко + 60г гранола + 20г мед",
    gap_meal_pb_toast: "Филии с фъстъчено масло: 2 филии хляб + 40г фъстъчено масло + 1 банан",
    ...
    scan_scale_btn: "Сканирай екран от везната",
    scale_scanning: "Разчита се…",
    scale_scan_success: "Данните от везната са прочетени — провери и натисни Запиши",
    scale_body_fat_pct_label: "Телесни мазнини",
    scale_bmr_kcal_label: "БМР",
    scale_protein_pct_label: "Протеин",
